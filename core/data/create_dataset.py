...
def create_dataset(data_type='train', evaluate=False):
    print(data_type)
    print(cfg[data_type])
...
def create_dataloader(data_type='train', evaluate=False):
    ...
    dataset = create_dataset(data_type=data_type, evaluate=evaluate)
